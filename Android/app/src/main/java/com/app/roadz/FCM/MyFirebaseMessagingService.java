...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.d(TAG, "Data: " + remoteMessage.getNotification().getBody() + "");
        Log.d(TAG, "Data: " + remoteMessage.getNotification().getTitle() + "");
        int post_id = 0;
...
//                }
//            }
            sendNotification(remoteMessage.getData().toString(), remoteMessage.getNotification().getTitle());
            return;
        }
    }

    private void sendNotification(String messageBody, String tiitle) {
        ...
        if (currentapiVersion >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
            ...
            NotificationCompat.Action actionNotifyNextTime = new NotificationCompat.Action.Builder(R.mipmap.ic_launcher, messageBody, pendingIntentNotify).build();
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                channel.setDescription(String.format(messageBody));
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this).setSmallIcon(R.mipmap.ic_launcher).setTicker(Html.fromHtml(messageBody)).setContentTitle(tiitle)
