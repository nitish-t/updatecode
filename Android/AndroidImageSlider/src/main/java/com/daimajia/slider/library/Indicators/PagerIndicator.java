...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener {
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        mDefaultSelectedColor = attributes.getColor(R.styleable.PagerIndicator_selected_color, Color.rgb(212, 54, 88));
        mDefaultUnSelectedColor = attributes.getColor(R.styleable.PagerIndicator_unselected_color, Color.rgb(89, 100, 66));
        ...
        mPadding_top = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_top,(int)pxFromDp(6));
        mPadding_bottom = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_bottom,(int)pxFromDp(6));
