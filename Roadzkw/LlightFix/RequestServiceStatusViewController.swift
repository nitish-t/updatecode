...
class RequestServiceStatusViewController: UIViewController {
...
//            UserProfile.sharedInstance.isSelectGest = NSNumber(value:false)
            ...
            self.btnClose.localized = "Registration"
     ...
     //       self.lblSubTitle.isHidden = false
            ...
            return
             ...
             let text = "ServiceStatusVC.lblWeAreOnTheWay.text".localize_ 
            let textRange = NSMakeRange(0, text.count)
            let attributedText = NSMutableAttributedString(string: text)
            attributedText.addAttribute(NSAttributedString.Key.underlineStyle , value: NSUnderlineStyle.single.rawValue, range: textRange)
            lblWeAreOnTheWay.attributedText =  attributedText
